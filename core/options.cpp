...
bool Options::Parse(int argc, char *argv[]) {
    ...
    config_filename = config_file_override;
    ifs.open(config_filename.c_str());
    if (!ifs.is_open()) {
        std::cout << "config override not found: " << config_filename << " try to load: " << config_file
                  << std::endl;
    ...
    if (ifs.is_open()) {
        std::cout << "Loading options from: " << config_filename << std::endl;
...
void Options::Print() const {
    ...
    if (!config_file_override.empty())
        std::cout << "    config file override: " << config_file_override << std::endl;
